...
const {isSidebaropen, closeSidebar} = useContext(AppContext)
  return(
    ...
    <div className={`${isSidebaropen ? 'sidebar show': 'sidebar'}`}>
        ...
        <button className='absolute top-4 right-4 text-[30px] text-[grey] ' onClick={closeSidebar}>
          <FaTimes/>
        </button>
                        ...
                        <div key={index} className='p-3'>
                            ...
                            <div className='flex flex-wrap p-3' >
                                {links.map((link, index)=>{
                                    ...
                                    return(
                                        <a className='text-[rgb(97,125,152)] flex items-center w-[50%] flex-wrap' key={index} href={url}>
