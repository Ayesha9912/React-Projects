...
const proArray = [
    {id: 1, img1: free1 , img2: free3},
    {id: 2, img1: free2 , img2: free5},
    {id: 3, img1: free3 , img2: free8},
    {id: 4, img1: free4 , img2: free1},
    {id: 5, img1: free5 , img2: free9},
    {id: 6, img1: free6 , img2: free4},
    {id: 7, img1: free7 , img2: free2},
    {id: 8, img1: free8 , img2: free7},
    {id: 9, img1: free9 , img2: free6},
]
  return(
    ...
    <div className="slider-container">
      <Slider {...settings}>
        ...
        <div key={index}>
            ...
            <div className="imgicons"><FaHeart className="faicons"/><FaSignal className="faicons"/><FaEye className="faicons"/></div>
            </div>
            </div>
            </div>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates maxime vel similique perferendis, eum tempora rem eos esse. Pariatur autem odio reprehenderit, labore et, voluptates.....</p>
